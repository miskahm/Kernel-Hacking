...
main (int argc, char *argv[])
{
  ...
  24:	50                   	push   %eax
  25:	50                   	push   %eax
  26:	68 9b 07 00 00       	push   $0x79b
  2b:	6a 02                	push   $0x2
  2d:	e8 fe 03 00 00       	call   430 <printf>
        exit();
  32:	e8 9c 02 00 00       	call   2d3 <exit>
        if (strcmp(argv[1],"-r") ==0)
  37:	51                   	push   %ecx
  38:	51                   	push   %ecx
  39:	68 98 07 00 00       	push   $0x798
  3e:	ff 72 04             	pushl  0x4(%edx)
  41:	e8 5a 00 00 00       	call   a0 <strcmp>
  ...
  50:	6a 01                	push   $0x1
  52:	e8 1c 03 00 00       	call   373 <count>
            exit();
  57:	e8 77 02 00 00       	call   2d3 <exit>
        count(i);
  5c:	83 ec 0c             	sub    $0xc,%esp
  5f:	6a 00                	push   $0x0
  61:	e8 0d 03 00 00       	call   373 <count>
        exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb b9 07 00 00       	mov    $0x7b9,%ebx
        while(*s != 0){
 ...
 605:	a1 64 0a 00 00       	mov    0xa64,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 64 0a 00 00    	mov    %edx,0xa64
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 64 0a 00 00    	mov    %edx,0xa64
    p->s.size += bp->s.size;
